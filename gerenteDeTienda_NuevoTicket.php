...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="gerenteDeTienda_FormularioTicket.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
<div class="row">
    <?php foreach ($Valores as $Val): ?>
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="gerenteDeTienda_FormularioTicket.php" class="card border-left-danger shadow h-100 py-2 btn btn-link text-left w-100">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="font-weight-bold text-danger text-uppercase mb-1">
