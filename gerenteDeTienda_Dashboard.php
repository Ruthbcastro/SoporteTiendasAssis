...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Gerente de Tienda</h1>
    <a href="gerenteDeTienda_NuevoTicket.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
<div class="col-xl-6 col-md-5 mb-6">
    <a href="gerenteDeTienda_MisTickets.php"  class="card border-left-primary shadow h-100 py-2 btn btn-link text-left w-100" >
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="h5 font-weight-bold text-primary text-uppercase mb-1">Mis tickets</div>
...
<div class="col-xl-6 col-md-5 mb-6">
    <a href="gerenteDeTienda_NuevoTicket.php" class="card border-left-success shadow h-100 py-2 btn btn-link text-left w-100" >
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
